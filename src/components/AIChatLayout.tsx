...
const AIChatLayout: React.FC<AIChatLayoutProps> = ({ children, footerSlot }) => {
  return (
    <div className="relative flex h-full min-h-0 flex-1 overflow-hidden">
      ...
      <div className="relative mx-auto flex h-full w-full max-w-full flex-1 px-0 py-0 sm:max-w-4xl sm:px-4 sm:py-4 lg:max-w-6xl lg:px-6 lg:py-6 xl:max-w-[90rem] xl:px-8 xl:py-8 2xl:max-w-[100rem] 2xl:px-10 2xl:py-10">
