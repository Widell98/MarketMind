...
const PortfolioSummaryView = ({ portfolio }: PortfolioSummaryViewProps) => {
  ...
  return (
    <div className="space-y-6 text-base leading-relaxed text-foreground animate-in fade-in-50 slide-in-from-bottom-4 duration-500">
      ...
      {isAnalysis && (
        <div className="rounded-xl border-2 border-primary/10 bg-gradient-to-br from-card/90 to-card/50 p-6 shadow-lg backdrop-blur-sm">
          ...
          {advisorPlan.risk_alignment && (
            <div className="p-6 rounded-xl border-2 border-primary/20 bg-gradient-to-br from-card/80 to-card/40 shadow-md backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-lg bg-amber-500/10 flex items-center justify-center border border-amber-500/20">
                  <Brain className="h-5 w-5 text-amber-600 dark:text-amber-400" />
                </div>
                <h4 className="text-lg font-bold text-foreground">Detaljerad analys</h4>
              </div>
