...
import { Upload, Edit, Trash2, Plus, Save, TrendingUp, X } from 'lucide-react';
...
const UserStockCasesSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Fel",
        description: error.message || "Kunde inte uppdatera aktiecase",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  return (
    <div className="space-y-6">
      {editingCase && (
        <Card>
          <CardHeader>
            <CardTitle>Redigera Akticase</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button onClick={() => navigate('/my-stock-cases')}>
