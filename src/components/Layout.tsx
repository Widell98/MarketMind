...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const rootClassName = isChatRoute
    ? 'h-screen w-full flex flex-col overflow-hidden bg-white dark:bg-background'
    : 'min-h-screen bg-background w-full flex flex-col overflow-hidden';
      ...
      <div className={rootClassName}>
        <div className="flex-1 flex flex-col min-w-0 max-w-full">
          ...
          <header className="sticky top-0 z-40 bg-card/95 backdrop-blur-sm border-b border-border shadow-sm">
            <div className="container-responsive py-2 sm:py-3 lg:py-4 grid grid-cols-[auto,1fr,auto] items-center gap-4 md:gap-6">
              ...
              <div className="flex items-center justify-end space-x-1 sm:space-x-2 md:space-x-3 flex-shrink-0">
                <ThemeToggle />
                {/* <LanguageToggle /> */}
                {user ? (
                  <ProfileMenu />
