      ...
      <Card className="bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-950 dark:to-emerald-900 border-green-200 dark:border-green-800">
        <CardContent className="pt-3 pb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-lg md:text-xl font-bold text-green-900 dark:text-green-100">
                {isLoading ? '...' : activeCases || 156}
              </div>
              <p className="text-xs md:text-sm text-green-700 dark:text-green-300">Active Cases</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="pt-3 pb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs md:text-sm text-blue-700 dark:text-blue-300">Community Members</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-gradient-to-br from-purple-50 to-pink-100 dark:from-purple-950 dark:to-pink-900 border-purple-200 dark:border-purple-800">
        <CardContent className="pt-3 pb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-lg md:text-xl font-bold text-purple-900 dark:text-purple-100">
                {isLoading ? '...' : totalCases || 324}
              </div>
              <p className="text-xs md:text-sm text-purple-700 dark:text-purple-300">Cases Shared</p>
            </div>
          </div>
        </CardContent>
      </Card>
