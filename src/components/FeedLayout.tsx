    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/20 dark:from-gray-900 dark:via-blue-950/20 dark:to-purple-950/10">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-blue-700 to-purple-700 text-white">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-8 h-8 bg-white/1 rounded-full blur-xl -translate-x-1/2 -translate-y-1/2"></div>
          <div className="absolute top-0 right-0 w-10 h-10 bg-purple-400/1 rounded-full blur-xl translate-x-1/3 -translate-y-1/3"></div>
          <div className="absolute bottom-0 left-1/3 w-9 h-9 bg-blue-400/1 rounded-full blur-xl translate-y-1/2"></div>
        </div>
        
        {/* Very subtle grid pattern overlay */}
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20width%3D%2260%22%20height%3D%2260%22%20viewBox%3D%220%200%2060%2060%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%3Cg%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%3E%3Cg%20fill%3D%22%23ffffff%22%20fill-opacity%3D%220.01%22%3E%3Cpath%20d%3D%22M36%2034v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6%2034v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6%204V0H4v4H0v2h4v4h2V6h4V4H6z%22/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-5"></div>
        ...
        <div className="relative py-4 md:py-6">
          <div className="container mx-auto px-4 relative">
            <div className="max-w-4xl text-center mx-auto">
              ...
              {/* AI-Powered subtitle */}
              <div className="mb-4">
                <p className="text-blue-100/90 text-base md:text-lg font-medium max-w-2xl mx-auto leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-2 mb-4">
                <div className="flex items-center gap-2 bg-white/15 backdrop-blur-md rounded-full px-4 py-1.5 border border-white/20 shadow-lg">
                  <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse shadow-lg shadow-green-400/50"></div>
                  <span className="text-xs font-semibold text-blue-50">Live Updates</span>
                </div>
                ...
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-full px-4 py-1.5 border border-white/20">
                  ...
                  <span className="text-xs font-medium text-blue-100">AI-Powered</span>
                </div>
                
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-full px-4 py-1.5 border border-white/20">
                  <BarChart3 className="w-3 h-3 text-purple-300" />
                  <span className="text-xs font-medium text-blue-100">Expert Analysis</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 -mt-1 relative">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          {/* Main Content Area - Removed z-index */}
          <div className="lg:col-span-3 relative">
            {/* Navigation Tabs - Removed z-index */}
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 dark:border-gray-700/50 p-2 mb-8 relative">
