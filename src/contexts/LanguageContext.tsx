...
const translations = {
  sv: {
    ...
    'aiChat.riskProfileNoticeTitle': 'Svara på några snabba frågor för bättre rådgivning',
    'aiChat.riskProfileNoticeDesc': 'Du kan börja chatta direkt och komplettera din riskprofil när det passar. Ju mer vi vet om dig, desto mer träffsäkra råd kan vi ge.',
    'aiChat.manageProfile': 'Visa profil',
  ...
  en: {
    ...
    'aiChat.riskProfileNoticeTitle': 'Answer a few quick questions for better advice',
    'aiChat.riskProfileNoticeDesc': 'You can start chatting right away and complete your risk profile whenever it suits you. The more we know, the more tailored the guidance becomes.',
    'aiChat.manageProfile': 'View profile',
