                    ...
                    <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
                      {quickActions.map(({ icon: Icon, title, description, to }) => (
                        <Button
                          ...
                          asChild
                          variant="outline"
                          className="group h-full w-full justify-start rounded-2xl border-border/60 bg-card/60 p-4 text-left transition-all duration-200 hover:border-primary/30 hover:bg-primary/5 hover:shadow-md sm:p-5"
                        >
                          <Link to={to} className="flex h-full flex-col items-start gap-3">
                            ...
                            <div className="space-y-1">
                              ...
                              <span className="text-xs leading-relaxed text-muted-foreground sm:text-sm">{description}</span>
                            </div>
                          </Link>
                        </Button>
                      ))}
