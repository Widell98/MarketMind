          ...
          <div className="w-full">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full space-y-2 sm:space-y-4">
              ...
              <div className="w-full max-w-full">
                <TabsContent value="overview" className="mt-2 sm:mt-4 focus-visible:outline-none w-full">
                  <div className="w-full max-w-full">
                    <PortfolioOverview
                ...
                <TabsContent value="chat" className="mt-2 sm:mt-4 focus-visible:outline-none w-full">
                  <div className="w-full max-w-full">
                    <AIChat portfolioId={activePortfolio?.id} />
                  </div>
                </TabsContent>

                <TabsContent value="portfolio" className="mt-2 sm:mt-4 focus-visible:outline-none w-full">
                  <div className="w-full max-w-full">
                ...
                <TabsContent value="health" className="mt-2 sm:mt-4 focus-visible:outline-none w-full">
                ...
                <TabsContent value="scenarios" className="mt-2 sm:mt-4 focus-visible:outline-none w-full">
                  <div className="w-full max-w-full">
                    <ScenarioAnalysis portfolio={activePortfolio} />
                  </div>
                </TabsContent>

                <TabsContent value="settings" className="mt-2 sm:mt-4 focus-visible:outline-none w-full">
