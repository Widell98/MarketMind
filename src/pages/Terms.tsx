  ...
  return (
    <Layout>
      <div className="prose dark:prose-invert max-w-none">
        <h1>Tjänstevillkor (Terms of Service)</h1>
        ...
        <p>
          ...
          dubbeldebitering. Kontakta oss på support@market-mind.app.
        </p>
        ...
        <h2>11. Kontakt</h2>
        <p>
          Frågor om Tjänsten eller Villkoren skickas till:<br />
          📧 support@market-mind.app<br />
          📍 MarketMind AB
        </p>
      </div>
    </Layout>
