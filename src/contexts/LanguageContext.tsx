...
const translations = {
  sv: {
    ...
    // AI Chat Page
    'aiChat.title': 'AI Portföljanalytiker',
    'aiChat.subtitle': 'Din datadrivna investeringsanalytiker som hjälper dig att fatta smartare beslut med AI-drivna insikter',
    ...
    'aiChat.demo.loginPrompt': 'Skapa ett konto för att få personliga AI-insikter och portföljanalys',
    'aiChat.demo.loginButton': 'Logga in / Skapa konto',
    'aiChat.demo.assistantGreeting': 'Hej! Jag är din AI Portföljanalytiker. Jag hjälper dig med investeringsanalys, portföljdiagnoser och marknadsinsikter. Vad kan jag analysera åt dig idag?',
    'aiChat.demo.userExample': 'Gör en analys av tesla',
    'aiChat.demo.assistantResponse': 'Tesla (TSLA) är definitivt en intressant investering att diskutera! För att ge dig den mest träffsäkra analysen behöver jag veta mer om din investeringsprofil och mål. Skapa ett konto så kan jag leverera personliga insikter baserat på din riskprofil.',
  ...
  en: {
    ...
    // AI Chat Page
    'aiChat.title': 'AI Portfolio Analyst',
    'aiChat.subtitle': 'Your intelligent investment analyst delivering smarter decisions with AI-driven insights',
    ...
    'aiChat.demo.loginPrompt': 'Create an account to get personalized AI insights and portfolio analysis',
    'aiChat.demo.loginButton': 'Login / Create account',
    'aiChat.demo.assistantGreeting': 'Hi! I\'m your AI Portfolio Analyst. I help you with investment analysis, portfolio diagnostics, and market insights. What can I dig into for you today?',
    'aiChat.demo.userExample': 'Do an analysis of Tesla',
    'aiChat.demo.assistantResponse': 'Tesla (TSLA) is definitely an interesting investment to discuss! To provide the sharpest analysis I need to know more about your investment profile and goals. Create an account so I can deliver personalized insights based on your risk profile.',
