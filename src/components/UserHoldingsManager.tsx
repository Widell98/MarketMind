        ...
        <CardContent className="space-y-3 sm:space-y-4 p-3 sm:p-4 md:p-6 pt-0">
          {loading || cashLoading ? (
            ...
            <div className="space-y-3 sm:space-y-4">
              {/* Action Bar */}
              <div className="flex flex-col gap-3 sm:gap-3.5 pb-3 sm:pb-4 border-b border-border">
              ...
              {allHoldings.length > 0 && (
                <div className="text-xs text-muted-foreground pt-4 border-t border-border flex items-center gap-2">
                  ...
                  <span>Klicka på en ticker för att uppdatera priset eller hämta senaste kurs.</span>
                </div>
              )}
            </div>
          )}
