...
const translations = {
  sv: {
    ...
    'aiChat.riskProfileDesc': 'Ställ in din riskprofil under Profil > Riskprofil för att använda AI-assistenten',
    'aiChat.createRiskProfile': 'Öppna riskprofil',
  ...
  en: {
    ...
    'aiChat.riskProfileDesc': 'Set your risk profile under Profile > Risk Profile to use the AI assistant',
    'aiChat.createRiskProfile': 'Open risk profile',
