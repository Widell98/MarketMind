...
import { abbreviateMetricLabel, formatKeyMetricValue } from '@/lib/format';
                    ...
                    <div className="mt-4 grid gap-3 sm:grid-cols-2">
                      {report.keyMetrics.map((metric, metricIndex) => (
                        <div
                          ...
                          className="flex items-center justify-between gap-3 rounded-full border border-border/70 bg-card/70 px-3 py-2 text-left shadow-sm"
                        >
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <span className="inline-flex items-center gap-1 rounded-full bg-muted px-2 py-1 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground leading-4">
                                {abbreviateMetricLabel(metric.label)}
                              </span>
                            </TooltipTrigger>
                            <TooltipContent side="top">{metric.label}</TooltipContent>
                          </Tooltip>
                          <div className="text-right leading-tight">
                            <p className="text-lg font-semibold text-foreground sm:text-xl">{formatKeyMetricValue(metric.value)}</p>
