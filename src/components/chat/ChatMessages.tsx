...
const ChatMessages = ({
  ...
  if (isLoadingSession) {
    return (
      ...
      >
        <div className="mx-auto w-full max-w-4xl space-y-6 px-4 py-7 sm:px-6 sm:py-8 md:max-w-5xl lg:max-w-6xl lg:space-y-8 lg:px-10 lg:py-10 xl:max-w-[1240px] xl:px-12 2xl:max-w-[1400px] 2xl:px-16 2xl:py-12">
          {[1, 2, 3].map((item) => (
  ...
  return (
    <div
      ...
      style={{ scrollbarGutter: 'stable' }}
    >
      <div className="mx-auto w-full max-w-4xl space-y-6 px-4 py-6 sm:space-y-7 sm:px-6 sm:py-8 md:max-w-5xl lg:max-w-6xl lg:space-y-8 lg:px-10 lg:py-10 xl:max-w-[1240px] xl:space-y-9 xl:px-12 xl:py-12 2xl:max-w-[1400px] 2xl:space-y-10 2xl:px-16">
        {showGuideBot && (
          <GuideBot
