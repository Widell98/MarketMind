    ...
    <Layout>
      <div className="min-h-0 bg-background">
        <div className="w-full max-w-5xl xl:max-w-6xl mx-auto px-3 sm:px-6 py-5 sm:py-9 lg:py-12">
          ...
          {/* Hero Section - Visas endast om ej inloggad */}
          {!user && (
            <div className="mb-16 sm:mb-20 lg:mb-24">
              {/* Hero Content - Orörd kod från originalfilen för icke-inloggade */}
          ...
          {/* DASHBOARD - För inloggade användare med portfölj */}
          {user && hasPortfolio && (
            <div className="min-h-0 bg-background">
              <div className="w-full max-w-6xl mx-auto px-2 sm:px-4 py-2 sm:py-4">
                <div className="space-y-6 sm:space-y-8">
                  
                  {/* 1. Market Pulse - Makroöverblick */}
                  <MarketPulse />

                  {/* 2. Morning Brief / Flash Briefs - AI-Insikter */}
                  <FlashBriefs 
                    morningBrief={morningBrief} 
                    title="Morgonrapport & Nyheter" 
                    showSummary={true}
                  />

                  {/* 3. Portfolio Focus - Endast procentuell utveckling */}
                  ...
                  <section className="rounded-3xl border border-border/60 bg-card/80 p-4 shadow-sm sm:p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-base font-semibold text-foreground sm:text-lg">Bevakningslista</h2>
                      </div>
                    ...
                    {likedStockCasesLoading ? (
                      ...
                      <div className="rounded-2xl border border-dashed border-border/60 bg-muted/20 p-8 text-center">
                        ...
                        <h3 className="text-lg font-semibold mb-2">Inga bevakade aktier</h3>
                        <p className="text-sm text-muted-foreground mb-4">
                          Spara intressanta case för att följa dem här.
                        </p>
                        <Button asChild>
                          <Link to="/discover">
          ...
          {/* Onboarding för användare utan portfölj */}
