                  ...
                  <div className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                    {highlightedMetrics.map((metric, index) => (
                      <div
                        ...
                        className="flex items-center justify-between gap-3 rounded-full border border-border/70 bg-muted/40 px-3 py-2 text-left shadow-sm"
                      >
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <span className="inline-flex items-center gap-1 rounded-full bg-card/70 px-2 py-1 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground leading-4">
                        ...
                        <div className="text-right leading-tight">
                          <p className="text-base font-semibold text-foreground sm:text-lg">
                            {formatKeyMetricValue(metric.value)}
                          </p>
