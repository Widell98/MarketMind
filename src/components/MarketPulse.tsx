  ...
  return (
    <div className="mb-8">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-semibold text-finance-navy">Market Pulse</h2>
        <span className="text-xs text-finance-gray">Uppdaterad 08:30</span>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2 mb-4">
        {marketIndices.map((index) => (
          <div key={index.symbol} className="card-finance p-2 flex flex-col">
            <div className="text-xs text-finance-gray mb-0.5">{index.symbol}</div>
            <div className="font-medium">{index.price.toLocaleString('sv-SE')}</div>
      ...
      {/* Top Performers */}
      <div className="mb-4">
        <h3 className="text-sm font-medium mb-2 text-finance-blue">Topprestanda</h3>
      ...
      {/* Bottom Performers */}
      <div>
        <h3 className="text-sm font-medium mb-2 text-finance-blue">Lägsta prestanda</h3>
        <div className="space-y-2">
